...
from backend.issue_reports.issue_reports_routes import issue_report_routes
import os
...
def create_app():
    ...
    app.register_blueprint(issue_report_routes, url_prefix='/ir')
